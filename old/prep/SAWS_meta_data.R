...
##### NB #####
# The .csv file this commented out section is based on has dissapeared
# The product is still where it was saved
#####
...
# Load data ----------------------
## This file is generated by "SAWS_data_clean.R" which currently lacks the first few steps that are commented out above
## The above steps need to be moved and this work flow needs to be cleaned up
